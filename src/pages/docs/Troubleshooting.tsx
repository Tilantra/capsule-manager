                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-sm leading-relaxed text-indigo-700 dark:text-indigo-300">
                                Calm down guys!! 😊 We are hitting our Google sign-in limits and are throttling because of the massive volume of users (90k users in just 45 days!). If you are facing sign-in issues with Google, please try again later.
                            </p>
                        </div>
                    </div>
                </div>
